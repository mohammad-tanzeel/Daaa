...
jQuery.validator.addMethod("letterswithspace", function(value, element) {
    return this.optional(element) || /^[a-zA-Z]+\s?([a-zA-Z]+\s?){0,5}$/i.test(value);
}, "Letters or space only please");
...
jQuery.validator.addMethod("minute", function(value, element) {
    return this.optional(element) || /^([0-9]|[1-5][0-9])$/i.test(value);
}, "Enter valid minute value(0-59)");
jQuery.validator.addMethod("hour", function(value, element) {
    return this.optional(element) || /^([0-9]|1[0-9]|2[0-3])$/i.test(value);
}, "Enter valid hour value(0-23)");
jQuery.validator.addMethod("day", function(value, element) {
    return this.optional(element) || /^([1-9]|[12][0-9]|3[01])$/i.test(value);
}, "Enter valid day value(1-31)");
jQuery.validator.addMethod("month", function(value, element) {
    return this.optional(element) || /^([1-9]|1[0-2])$/i.test(value);
}, "Enter valid month value(1-12)");
$.validator.addMethod("dayofweek", function(value, element) {
    return this.optional(element) || /^[0-7]$/i.test(value);
}, "Enter valid day of week value(0-7)");
jQuery.validator.addMethod("rolevalue", function(value, element) {
    return this.optional(element) || /^[2-4]$/i.test(value);
}, "Enter role value(2-4)");
jQuery.validator.addMethod("primenumber", function(value, element) {
    return this.optional(element) || /^[1-9]+$/i.test(value);
}, "Digits only (Prime numbers)");
jQuery.validator.addMethod("fixvaluerealmoney", function(value, element) {
    return this.optional(element) || /^[0-2]+/i.test(value);
}, "Possible value 0,1 or 2.");
jQuery.validator.addMethod("fixvaluebuypage", function(value, element) {
    return this.optional(element) || /^[1-6]+/i.test(value);
}, "Possible value between 1-6.");
...
},'Date To" must be greater then or equals to "Date From');
...
},'Date From" must be less then or equals to "Date To');
...
}, "Amount must be greater then equals to 0");
...
},'Amount is must be less then or equals to Amount To');
...
},'Amount is must be greater then or equals to Amount From');
